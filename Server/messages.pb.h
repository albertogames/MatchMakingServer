...
class Message_UserAvailable : public ::google::protobuf::Message {
 public:
  Message_UserAvailable();
  virtual ~Message_UserAvailable();

  Message_UserAvailable(const Message_UserAvailable& from);

  inline Message_UserAvailable& operator=(const Message_UserAvailable& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const Message_UserAvailable& default_instance();

  void Swap(Message_UserAvailable* other);

  // implements Message ----------------------------------------------

  Message_UserAvailable* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const Message_UserAvailable& from);
  void MergeFrom(const Message_UserAvailable& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:Messages.Message.UserAvailable)
 private:
  inline void set_has_username();
  inline void clear_has_username();
  ...
  void InitAsDefaultInstance();
  static Message_UserAvailable* default_instance_;
};
// -------------------------------------------------------------------
...
class Message : public ::google::protobuf::Message {
 public:
  ...
  typedef Message_UserAvailable UserAvailable;
  ...
  inline bool has_useravailable() const;
  inline void clear_useravailable();
  static const int kUserAvailableFieldNumber = 3;
  inline const ::Messages::Message_UserAvailable& useravailable() const;
  inline ::Messages::Message_UserAvailable* mutable_useravailable();
  inline ::Messages::Message_UserAvailable* release_useravailable();
  inline void set_allocated_useravailable(::Messages::Message_UserAvailable* useravailable);
 ...
 private:
  ...
  inline void set_has_useravailable();
  inline void clear_has_useravailable();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::Messages::Message_Login* login_;
  ::Messages::Message_UserAvailable* useravailable_;
  int messagetype_;
...
// required string username = 1;
inline bool Message_UserAvailable::has_username() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Message_UserAvailable::set_has_username() {
  _has_bits_[0] |= 0x00000001u;
}
inline void Message_UserAvailable::clear_has_username() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void Message_UserAvailable::clear_username() {
  if (username_ != &::google::protobuf::internal::kEmptyString) {
    username_->clear();
  }
  clear_has_username();
}
inline const ::std::string& Message_UserAvailable::username() const {
  return *username_;
}
inline void Message_UserAvailable::set_username(const ::std::string& value) {
  set_has_username();
  if (username_ == &::google::protobuf::internal::kEmptyString) {
    username_ = new ::std::string;
  }
...
inline void Message_UserAvailable::set_username(const char* value) {
  set_has_username();
  if (username_ == &::google::protobuf::internal::kEmptyString) {
    username_ = new ::std::string;
  }
...
inline void Message_UserAvailable::set_username(const char* value, size_t size) {
  set_has_username();
  if (username_ == &::google::protobuf::internal::kEmptyString) {
    username_ = new ::std::string;
  }
...
inline ::std::string* Message_UserAvailable::mutable_username() {
  set_has_username();
  if (username_ == &::google::protobuf::internal::kEmptyString) {
    username_ = new ::std::string;
  }
...
inline ::std::string* Message_UserAvailable::release_username() {
  clear_has_username();
  if (username_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
...
inline void Message_UserAvailable::set_allocated_username(::std::string* username) {
  if (username_ != &::google::protobuf::internal::kEmptyString) {
    delete username_;
  }
  if (username) {
...
// optional .Messages.Message.UserAvailable userAvailable = 3;
inline bool Message::has_useravailable() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void Message::set_has_useravailable() {
  _has_bits_[0] |= 0x00000004u;
}
inline void Message::clear_has_useravailable() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void Message::clear_useravailable() {
  if (useravailable_ != NULL) useravailable_->::Messages::Message_UserAvailable::Clear();
  clear_has_useravailable();
}
inline const ::Messages::Message_UserAvailable& Message::useravailable() const {
  return useravailable_ != NULL ? *useravailable_ : *default_instance_->useravailable_;
}
inline ::Messages::Message_UserAvailable* Message::mutable_useravailable() {
  set_has_useravailable();
  if (useravailable_ == NULL) useravailable_ = new ::Messages::Message_UserAvailable;
  return useravailable_;
}
inline ::Messages::Message_UserAvailable* Message::release_useravailable() {
  clear_has_useravailable();
  ::Messages::Message_UserAvailable* temp = useravailable_;
  useravailable_ = NULL;
  return temp;
}
inline void Message::set_allocated_useravailable(::Messages::Message_UserAvailable* useravailable) {
  delete useravailable_;
  useravailable_ = useravailable;
  if (useravailable) {
    set_has_useravailable();
  } else {
    clear_has_useravailable();
