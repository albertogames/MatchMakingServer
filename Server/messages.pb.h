...
enum Message_MessageType {
  ...
  Message_MessageType_NEW_PLAYER_DISP_PLAY = 4,
  Message_MessageType_NEW_PLAYER_DISP_PLAY_CANCEL = 5
};
bool Message_MessageType_IsValid(int value);
const Message_MessageType Message_MessageType_MessageType_MIN = Message_MessageType_DISP_PLAY;
const Message_MessageType Message_MessageType_MessageType_MAX = Message_MessageType_NEW_PLAYER_DISP_PLAY_CANCEL;
...
class Message : public ::google::protobuf::Message {
 public:
  ...
  static const MessageType NEW_PLAYER_DISP_PLAY = Message_MessageType_NEW_PLAYER_DISP_PLAY;
  static const MessageType NEW_PLAYER_DISP_PLAY_CANCEL = Message_MessageType_NEW_PLAYER_DISP_PLAY_CANCEL;
